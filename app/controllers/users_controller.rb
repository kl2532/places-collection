class UsersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @user.update(user_params)
        puts "update"
        puts user_params
        puts user_params == "places_attributes"
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:first_name, :last_name, :email, :linked_in, :github, 
        places_attributes: [:id, :name, :rating, :public_place], public_lists_attributes: [:id, :name, :description, :places])
    end
end